...
// interface LEDSignBuilderToolProps {
//   addToCart: (selections: Selections) => void;
// }
...
//   const handleLocationChange: (loc: string) => void = (loc) => setLocation(loc);
...
//     setCustomSize({ width: 24, height: 12 }); // Set to default values
//   };
